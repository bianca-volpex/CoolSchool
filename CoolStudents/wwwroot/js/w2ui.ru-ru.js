{
    ...
    "phrases" : {
        ...
        "Loading...": "Загрузка...",
		"Line #":"№ п/п",
		"Save Grid State":"Сохранить статус колонок",
		"Restore Default State":"По умолчанию",
		"Search...":"Поиск...",
		"Name":"Имя",
		"Size":"Размер",
		"Type":"Тип",
        ...
        "email":"Эл.почта",
        "password":"Пароль",
        "confirmpassword":"Подтвердите<br>пароль",
        "Your remove data source record count has changed, reloading from the first record." : "Количество записей в базе данных было изменено, таблица перезагружена с первой записи."
    }
}